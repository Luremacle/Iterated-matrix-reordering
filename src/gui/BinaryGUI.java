...
public final class BinaryGUI extends JPanel implements MouseListener, MouseMotionListener, KeyListener {
	...
	private int dragX, dragY;
        ...
        public BinaryGUI(JLabel status, int[][] m) {
		super(true);
		this.status = status;
                this.matrix = m;
                this.original = m;
                this.h0 = 0.0; this.w0 = 0.0;
                this.h1 = m.length - 1;
                this.w1 = m[0].length - 1;
		addMouseListener(this);
		addMouseMotionListener(this);
                rowLabels = new int[m.length]; colLabels = new int[m[0].length];
	}
	...
	private void draw() {
		...
		time = System.currentTimeMillis();
                ...
                h0 = 0.0; w0 = 0.0;
                h1 = matrix.length-1; w1 = matrix[0].length-1;
                ...
                for(int r = 0; r < heightMinus; r++) {
                    for(int c = 0; c < widthMinus; c++) {
                        ...
                        if(SMOOTH) {
                            int count = 0; int square = (a_odd*b_odd);
